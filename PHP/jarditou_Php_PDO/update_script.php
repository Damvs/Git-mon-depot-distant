...
$requete = $db->prepare("UPDATE produits SET pro_ref=:pro_ref,pro_libelle=:pro_libelle,pro_description=:pro_description,pro_prix=:pro_prix,pro_stock=:pro_stock,pro_couleur=:pro_couleur,pro_bloque=:pro_bloque WHERE pro_id=:pro_id");
...
try{
// Construction de la requête INSERT sans injection SQL
$requete = $db->prepare("UPDATE categories SET cat_nom=:cat_nom WHERE cat_id=:cat_id");
