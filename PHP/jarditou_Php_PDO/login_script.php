...
&& !empty ($users_motdepasse))
{
    ...
    {   
        ...
        //$users_role= $check2["users_role"]; CREER LA COLONNE users_role en BDD

        /*$requete4= "SELECT users_tentative FROM users WHERE users_login=$users_login"; CREER LA COLONNE TENTATIVE EN BDD
        ...
        {*/
            if (password_verify($users_motdepasse,$check2['users_motdepasse'])) 
            {
                ...
                $requete3->closeCursor(); //probleme ne stock pas en bdd edit: devrait être regler avec insert to de la date à l'enregistrement
